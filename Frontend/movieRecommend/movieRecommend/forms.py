...
class LanguageGenreForm(forms.Form):
    language = forms.ChoiceField(choices=[('es', 'ES - Spanish'), ('en', 'EN - English')], widget=forms.Select(attrs={'class': 'form-select', 'style': 'width: 100%; padding: 10px; font-size: 16px; border-radius: 5px;'}))
